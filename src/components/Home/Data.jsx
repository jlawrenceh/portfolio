...
function Data() {
  return (
    <div className="home__data">
        ...
        I am a graduate of Bachelor of Science in Computer Science with specialization in Software Engineering. 
        
        </p>

        <div className="home__button-container">
          <a href="#contact" className="button home__btn button--flex">
              Message Me
              <i className="paperplane"><FaPaperPlane/></i>
